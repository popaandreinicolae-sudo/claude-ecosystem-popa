    ...
    return [
        types.Tool(
            ...
            inputSchema={
                "type": "object",
                "properties": {
                    "number": {"type": "integer", "description": "Numărul deciziei CCR"},
                    "year": {"type": "integer", "description": "Anul deciziei CCR"},
                },
        ...
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "number": {"type": "integer", "description": "Numărul actului"},
                    "year": {"type": "integer", "description": "Anul actului"},
                },
                "required": ["act_type", "number", "year"],
            },
        ),
        types.Tool(
            ...
            inputSchema={
                ...
                "properties": {
                    ...
                    "number": {"type": "integer", "description": "Numărul actului (0 pentru Constituție)"},
                    "year": {"type": "integer", "description": "Anul actului"},
                    "article": {"type": "integer", "description": "Numărul articolului"},
                    "alineat": {"type": "integer", "description": "Numărul alineatului (opțional)"},
                    "litera": {"type": "string", "description": "Litera (opțional, ex: 'a', 'b')"},
                },
                "required": ["act_type", "number", "year", "article"],
            },
        ),
        types.Tool(
            name="lege6_search",
